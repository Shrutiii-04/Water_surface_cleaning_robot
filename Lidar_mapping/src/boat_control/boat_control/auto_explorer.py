...
class AutoExplorer(Node):
    def __init__(self):
        ...
        self.declare_parameter('forward_speed', 30.0)      
        self.declare_parameter('turn_speed', 35.0)         
        self.declare_parameter('turn_ratio', 0.3)          
        self.declare_parameter('reverse_speed', -15.0)     
        self.declare_parameter('min_front_distance', 6.0)  
        self.declare_parameter('critical_distance', 3.5)   
        self.declare_parameter('side_clearance', 2.5)      
        self.declare_parameter('turn_duration', 3.0)       
        self.declare_parameter('reverse_duration', 2.0)    
        self.declare_parameter('stuck_threshold', 0.3)     
    ...
    def scan_callback(self, msg):
        ...
        for i, range_val in enumerate(msg.ranges):
            ...
            elif 0.52 < angle <= 1.05:  
                front_left_readings.append(range_val)
            elif -1.05 <= angle < -0.52:  
